class ElbConfig(object):
    def __init__(self, instance_protocol, instance_ports, loadbalancer_protocol, loadbalancer_ports, elb_health_check,
        ...
        :param loadbalancer_ports: ports for public and ELB to communicate via
        ...
        self.loadbalancer_ports = loadbalancer_ports
